...
class Controleur:
    ...
    def creer_batiment(self, type_batiment, etoile_id):
        if self.ressources_necessaires(type_batiment):
            self.actionsrequises.append([self.mon_nom, "creerbatiment", [type_batiment, etoile_id]])
            return True
        else:
            return False

    def augmenter_niveau_batiment(self, batiment_id, etoile_id):
        self.actionsrequises.append([self.mon_nom, "augmenterniveaubatiment", [batiment_id, etoile_id]])
    ...
    def reinitialiser_cargo(self, ids):
        self.modele.reinitialiser_cargo(ids)
    ...
    def exploration(self, vaisseau_id):
        self.actionsrequises.append([self.mon_nom, "explorer_inconnu", [vaisseau_id]])

    def ressources_necessaires(self, type_batiment, batiment=None):
        if self.modele.joueurs[self.mon_nom].ressources_necessaires(type_batiment, batiment):
            print("On a assez de ressources")
            return True
        else:
            print("On a pas assez de ressources")
            return False

    def creer_trou_noir(self, x, y):
        self.actionsrequises.append([self.mon_nom, "creer_trou_noir", [x, y]])

    def detruire_batiment(self, batiment_id, etoile_id):
        self.actionsrequises.append([self.mon_nom, "detruirebatiment", [batiment_id, etoile_id]])

    def ameliorer_vaisseau(self, vaisseau_id):
        self.actionsrequises.append([self.mon_nom, "ameliorer_vaisseau", [vaisseau_id]])

    def manipuler(self, vaisseau_id):
        self.actionsrequises.append([self.mon_nom, "manipuler", [vaisseau_id]])
