...
class Controleur():
    ...
    def cibler_flotte(self, idorigine, iddestination, type_cible, retour_prevu=None):
        self.actionsrequises.append([self.mon_nom, "ciblerflotte", [idorigine, iddestination, type_cible, retour_prevu]])
