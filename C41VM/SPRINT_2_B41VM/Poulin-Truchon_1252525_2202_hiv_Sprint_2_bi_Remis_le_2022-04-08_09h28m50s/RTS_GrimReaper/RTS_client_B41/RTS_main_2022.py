...
class Controleur():
    ...
    #SS
    def win(self,nom):
        self.vue.creer_cadre_win(self.monnom)
    ...
    def creer_partie(self, nom):
        ...
        # playsound('musique/Time.mp3')  PROGRAMME NE RÉPOND PAS
    ...
    def choix(self): ##Alex pour proposer un choix de retour des ames
        self.vue.action.choix()


if __name__ == '__main__':
    if not is_playing_menu:
        playsound('musique/Time.mp3', False)
        is_playing_menu = True
        print('musique')
    c = Controleur()
