...
class Fleche():
    ...
    def bouger(self):
        ...
        if dist <= self.taille/2:
            # tue daim
            self.parent.actioncourante = "ciblerressource"
            self.parent.fleche.remove(self)
            self.proie.mourir()
        else:
            dist = Helper.calcDistance(self.x, self.y, self.proiex, self.proiey)
            if dist < self.vitesse:
...
class Ballista(Perso):
    def __init__(self, parent, id, maison, couleur, x, y, montype):
        ...
        self.etats_et_actions = {"bouger": self.bouger,
                                 ...
                                 "validerfleche": self.valider_fleche
                                 }
    ...
    def cibler_proie(self):
        ...
        if reponse == "rendu":
            ...
            self.actioncourante = "validerfleche"


    def valider_fleche(self):
        self.lancer_fleche(self.cible)
        for i in self.fleche:
            i.bouger()
    ...
    def lancer_fleche(self, proie):
        if self.fleche == []:
            id = get_prochain_id()
            self.fleche.append(Fleche(self, id, proie))
...
class Ouvrier(Perso):
    ...
    def chercher_nouvelle_ressource(self, typ, idreg):
        ...
        if typ != "baie" and  typ != "daim" and typ != "troupeEnnemis":
...
class Partie():
    ...
    def eliminer_ressource(self, type, ress):
        ...
        if type == "troupeEnnemis":
            print("troupeEnnemis a eliminer")
