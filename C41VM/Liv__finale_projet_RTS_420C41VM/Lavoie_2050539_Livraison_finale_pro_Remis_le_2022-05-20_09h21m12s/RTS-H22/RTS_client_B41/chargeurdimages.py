...
def chargerimages2():
    images = {
        ...
        'Battle_for_Wesnoth_logo': PhotoImage(file='images/divers/Battle_for_Wesnoth_logo.png'),
        'menu_background': PhotoImage(file="images/divers/menu_background.png"),
        'fin-defaite': PhotoImage(file="images/divers/fin-defaite.png"),
        'fin-victoire': PhotoImage(file="images/divers/fin-victoire.png")
    }
    return images
