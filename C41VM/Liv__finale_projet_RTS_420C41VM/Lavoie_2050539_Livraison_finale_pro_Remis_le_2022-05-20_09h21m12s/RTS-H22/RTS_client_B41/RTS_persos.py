...
class Ouvrier(Perso):
    ...
    def construire_batiment(self):
        if self.cible:
            ...
            if self.cible.delai <= 0:
                ...
                self.parent.batiments[self.cible.sorte][batiment.id] = batiment

                if self.site_construction.id in self.parent.batiments['siteconstruction']:
                    sitecons = self.parent.batiments['siteconstruction'].pop(self.site_construction.id)
    ...
    def construire_site_construction(self, site_construction):
        ...
        self.site_construction = site_construction
