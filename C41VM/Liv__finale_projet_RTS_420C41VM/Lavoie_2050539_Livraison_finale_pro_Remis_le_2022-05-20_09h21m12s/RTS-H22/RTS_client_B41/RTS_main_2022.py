...
class Controleur():
    def __init__(self):
        ...
        self.cadrejeu = 0  # compte les tours dans la boucle de jeu (bouclersurjeu) # TICKS!!!!!!
        ...
        self.moduloappeler_serveur = 1  # frequence des appel au serveur, evite de passer son temps a communiquer avec le serveur
        self.urlserveur = "http://127.0.0.1:7799"  # 127.0.0.1 pour tests,"http://votreidentifiant.pythonanywhere.com" pour web
    ...
    def reset_partie(self):
        ...
        reptext = self.appeler_serveur(leurl, None)
        self.vue.update_splash(reptext[0][0])
        return reptext

    # fonction d'appel normalisee d'appel pendant le jeu
    # fait un requete http a l'url dont les arguments sont params
    ...
    # genére un nom de type "JAJA_$num"
    ...
    def afficher_batiment(self, nom, batiment):  # methode appartient vue
    ...
    def afficher_fin_partie(self):
        ...
        self.vue.changer_cadre("fin_parti")
...
if __name__ == '__main__':
    ...
    winsound.PlaySound("./battle.wav", winsound.SND_FILENAME and winsound.SND_ASYNC)
    c = Controleur()
