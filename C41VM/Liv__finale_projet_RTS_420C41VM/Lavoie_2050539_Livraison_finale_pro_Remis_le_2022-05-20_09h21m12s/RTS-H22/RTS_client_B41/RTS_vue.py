...
from vue_lobby import Lobby
from vue_menu_fin_partie import MenuFinPartie
from vue_menu_principal import MenuPrincipal
...
class Vue:
    def __init__(self, controleur, urlserveur: str, monnom: str, testdispo: str):
        ...
        self.jeu = Jeu(self)
        self.menu_fin_partie = MenuFinPartie(self)

        self.changer_cadre("splash")
        # self.changer_cadre("fin_parti")
    ...
    def changer_cadre(self, nomcadre: str):
        cadre = {
            ...
            "lobby": self.lobby,
            "jeu": self.jeu,
            "fin_parti": self.menu_fin_partie
        }[nomcadre]
