...
May 20, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Remplacé toute instance de soldat @ guerrier, changements au niveau du z index
- Right-click Stele ne fonctionne pas, désactivé

May 19, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ajusté pour que les persos passent en dessous des obstacles plutot que par-dessus

May 18, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Nouveaux graphiques biotopes

May 16, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Resize les arbres, ajuster le comportement du uniteselect ( ne saute pas avec le perso)
- Nouvelles images d'arbres
- Added cheat to end the game (makes player's points = 1500)
- Fixed stealing rune
- Fixed bug where you could upgrade even without enough metal
- Added cheat code to upgrade all upgrades to max
- Fixed negative nbRune and fixed update_stele_image bug
- Fixed bug where chats would send twice
- Added cheats and changed starting resources
- Nouvelle image de selection ajouté

May 13, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ajouté barre de progrès sur constructions, corrigé bogue d'ouvrier qu… 

May 9, 2022
¯¯¯¯¯¯¯¯¯¯¯
- Implémenter delais attaque, fonctionnement de combats (attempt 2)
- Implémenter delais d'attaques pour guerriers et archers, modeAttaque …
- update guerrier
- classe knife pour guerrier (removed)

May 6, 2022
¯¯¯¯¯¯¯¯¯¯¯
- Version fonctionnelle sans crash à la mort de persos

May 2, 2022
¯¯¯¯¯¯¯¯¯¯¯
- Régler problème avec construire_batiment
- Régler problème avec déplacé (définition de "persochoisi" erroné)
- update verifer etat traverser soldat quand voler rune
- guerrier update (Kevin)

Apr 29, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Changer la sélection pour que clique-gauche sélectionne un perso à la fois
- Fixed spawning of persos to take into account upgrade levels
- Fix un bug qui ralentissait énormément l'affichage des persos morts
- Added neutral Stele in the middle of map
- Modifier bouger des persos pour qu'ils puissent se déplacer dans les biomes
- Ajout deplacement auto vers stèle ennemie et changement dans comment voler la rune ennemie

Apr 25, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Regler problemes d'attaque archer, detection de selection d'unite pour empecher ouvrier d'attaquer
- Streamlined stele image code
- Fixed bugs in stele image updating
- Made steles images update when stolen and stored
- Ajout deplacement qui enmène le soldat directement vers la stèle clickée
- Ajout permettant de vérifier que le soldat qui porte la rune n'est pas mort pendant son déplacement vers sa propre rune
- Ajout permettant de ramener la rune voler d'une stèle ennemie vers notre propre stèle

Apr 24, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ajout permettant de voler une rune d'un joueur adversaire

Apr 22, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ajouter image joueur mort
- Update attaque guerrier
- Update attaque 2
- Ouvrier considere tous types de sa cible (arbres, buissons) dans trouver_nouvelle_ressource
- Made it cost food to spawn persos
- Update attaque
- Added cap to upgrades
- Fixed upgrade labels not updating correctly

Apr 19, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Correction au deplacer et ramasser de l'ouvrier pour prendre en considération les modifs de la forge.
- Made upgrades work through server
- Modification du right click stèle
- Reglage du hud pour le nb de rune
- Ajout permettant de voler une rune d'un ennemie (le hud beug car il affiche uniquement l'incrementation de la rune, pas la décrementation de la rune volée)
- Vérification que la stèle voler n'est pas notre stèle et ajout mouvement soldat vers la stèle ennemie

Apr 11, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Fixed tool upgrades again
- Regler état vivant
- Fixed tool upgrades
- Commits on Apr 11, 2022
- Commit code Kevin pour attaquer_ennemie

Apr 8, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ajuster la boite de boutons pour la caserne
- Ajout permettant de voler la rune de l'ennemi (vérifie que la stèle n'est pas la sienne) (problème avec le nombre de rune a l'affichage de l'ennemie)
- Added window to spawn archers and guerriers to caserne; made the spawn actually work
- Upgrade fixed for the 20th time
- Mapper bouton action stèle et ajout de l'image de depart dans l'init de la classe Stele

Apr 4, 2022
¯¯¯¯¯¯¯¯¯¯¯¯
- Ferme fonctionnelle, se ravitaille automatiquement au cout de 25 bois
- Modifs aux fichiers images
